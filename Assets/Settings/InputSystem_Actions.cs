...
public partial class @InputSystem_Actions: IInputActionCollection2, IDisposable
{
        ...
        },
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""CancelTarget"",
                    ""type"": ""Button"",
                    ""id"": ""8999ede8-7c02-4f6e-a260-517c429e954a"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""b1a3b1a4-9783-4da7-b74b-38988efe2efc"",
                    ""path"": ""<Mouse>/leftButton"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""c81e39e0-3ac6-4c58-a539-39ec8f9bce76"",
                    ""path"": ""<Mouse>/rightButton"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ~@InputSystem_Actions()
    {
        ...
        UnityEngine.Debug.Assert(!m_SkillTargeting.enabled, "This will cause a leak and performance issues, InputSystem_Actions.SkillTargeting.Disable() has not been called.");
    }
    ...
    /// </summary>
    public struct SkillTargetingActions
    {
        private @InputSystem_Actions m_Wrapper;
        ...
        /// Provides access to the underlying input action map instance.
        /// </summary>
        public InputActionMap Get() { return m_Wrapper.m_SkillTargeting; }
        /// <inheritdoc cref="UnityEngine.InputSystem.InputActionMap.Enable()" />
        public void Enable() { Get().Enable(); }
        /// <inheritdoc cref="UnityEngine.InputSystem.InputActionMap.Disable()" />
        public void Disable() { Get().Disable(); }
        ...
        public bool enabled => Get().enabled;
        /// <summary>
        /// Implicitly converts an <see ref="SkillTargetingActions" /> to an <see ref="InputActionMap" /> instance.
        /// </summary>
        public static implicit operator InputActionMap(SkillTargetingActions set) { return set.Get(); }
        /// <summary>
        /// Adds <see cref="InputAction.started"/>, <see cref="InputAction.performed"/> and <see cref="InputAction.canceled"/> callbacks provided via <param cref="instance" /> on all input actions contained in this map.
        /// </summary>
        /// <param name="instance">Callback instance.</param>
        ...
        public void AddCallbacks(ISkillTargetingActions instance)
        {
        ...
        /// <summary>
        /// Unregisters <param cref="instance" /> and unregisters all input action callbacks via <see cref="SkillTargetingActions.UnregisterCallbacks(ISkillTargetingActions)" />.
        /// </summary>
        /// <seealso cref="SkillTargetingActions.UnregisterCallbacks(ISkillTargetingActions)" />
        public void RemoveCallbacks(ISkillTargetingActions instance)
        {
            if (m_Wrapper.m_SkillTargetingActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }
        ...
        /// If <paramref name="instance" /> is <c>null</c>, calling this method will only unregister all existing callbacks but not register any new callbacks.
        /// </remarks>
        /// <seealso cref="SkillTargetingActions.AddCallbacks(ISkillTargetingActions)" />
        /// <seealso cref="SkillTargetingActions.RemoveCallbacks(ISkillTargetingActions)" />
        /// <seealso cref="SkillTargetingActions.UnregisterCallbacks(ISkillTargetingActions)" />
        public void SetCallbacks(ISkillTargetingActions instance)
        {
            foreach (var item in m_Wrapper.m_SkillTargetingActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_SkillTargetingActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
    /// <summary>
    /// Provides a new <see cref="SkillTargetingActions" /> instance referencing this action map.
    /// </summary>
    public SkillTargetingActions @SkillTargeting => new SkillTargetingActions(this);
    ...
    /// <summary>
    /// Interface to implement callback methods for all input action callbacks associated with input actions defined by "SkillTargeting" which allows adding and removing callbacks.
    /// </summary>
    /// <seealso cref="SkillTargetingActions.AddCallbacks(ISkillTargetingActions)" />
    /// <seealso cref="SkillTargetingActions.RemoveCallbacks(ISkillTargetingActions)" />
